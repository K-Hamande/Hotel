...
<div class="testimonial" style="background-image: url(resources/uploads/slide2.jpg)">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12">
                <div class="testimonial-carousel owl-carousel">
                    <div class="item">
                        <div class="photo">
                            <img src=" {{Vite::asset('resources/uploads/t1.jpg')}}" alt="">
                        </div>
                        <div class="text">
                            <h4>Robert Krol</h4>
                            <p>CEO, ABC Company</p>
                    ...
                    <div class="item">
                        <div class="photo">
                            <img src=" {{Vite::asset('resources/uploads/t2.jpg')}}" alt="">
                        </div>
                        <div class="text">
                            <h4>Sal Harvey</h4>
